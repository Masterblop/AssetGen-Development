...
def DEF_pbrShader_add(
	...
	links.new( d_1.inputs[0],
		d_image_basecolor.outputs['Color'])
	...
	links.new( d_1.inputs[4],
		d_image_metallic.outputs['Color'])
	...
	links.new( d_1.inputs[7],
		d_image_roughness.outputs['Color'])
	...
	links.new(d_image.outputs['Color'],
		gamma.inputs['Color'])

	links.new(math.outputs['Value'],
		gamma.inputs['Gamma'])
	links.new(gamma.outputs['Color'],
		normal.inputs['Color'])
