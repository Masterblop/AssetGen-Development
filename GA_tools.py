...
class GA_PT_Tools_Wear(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.context.object.modifiers[
			"Decimate.001"].decimate_type = 'UNSUBDIV'

		bpy.context.object.modifiers[
			"Decimate.001"].iterations = 1
...
class GA_PT_Tools_OnTheGround(bpy.types.Operator):
	...
	def execute(self, context):
		...
		lowest_pt = min([(
			bpy.context.object.matrix_world @ v.co).z for
			v in bpy.context.object.data.vertices])
...
class GA_PT_Tools_Polycount(bpy.types.Operator):
	...
	def execute(self, context):
		...
		for obj in bpy.context.selected_objects:
			...
			bpy.context.object.name = str(len(
...
class GA_PT_Tools_BoltCubic(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
			"mirror":False},
			TRANSFORM_OT_translate={"value":(0, -1, 1),
			"constraint_axis":(False, False, False),
			"orient_type":'GLOBAL',
			"mirror":False,
			"proportional_edit_falloff":'SMOOTH',
...
class GA_PT_Tools_ChainHexagon(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.context.object.modifiers[
			"Array"].relative_offset_displace[2] = -0.75

		bpy.ops.object.modifier_add(type='CURVE')

		bpy.ops.transform.resize(
			value=(0.036, 0.036, 0.036),
			orient_type='GLOBAL',
			mirror=False,
			use_proportional_edit=False,
			proportional_edit_falloff='SMOOTH',
...
class GA_PT_Tools_Crack(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.transform.translate(
			value=(2.91038e-10, -1.19567e-10, -0.00840229),
			orient_type='GLOBAL',
			orient_matrix=(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			...
			"mirror":False},
			TRANSFORM_OT_translate={
			"value":(3.05311e-16, -0.0110057, 0.000306666),
			"orient_type":'GLOBAL',
			"orient_matrix":(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={
			...
			"mirror":False},
			TRANSFORM_OT_translate={
			"value":(0.000760137, 0.000605941, 1.90648e-06),
			"orient_type":'GLOBAL',
			"orient_matrix":(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={
			...
			"mirror":False},
			TRANSFORM_OT_translate={
			"value":(-8.21659e-07, 0.0155581, -0.00117957),
			"orient_type":'GLOBAL',
			"orient_matrix":(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={
			...
			"mirror":False},
			TRANSFORM_OT_translate={
			"value":(0.000399211, 0.0249536, -0.00217473),
			"orient_type":'GLOBAL',
			"orient_matrix":(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(MESH_OT_extrude_region={
			...
			"mirror":False},
			TRANSFORM_OT_translate={
			"value":(0.000492366, 0.0386664, -0.00316083),
			"orient_type":'GLOBAL',
			"orient_matrix":(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(4.94388e-05, 0.0108993, -0.000300644),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.transform.translate(
			value=(0.00172927, -1.19572e-10, -0.00793743),
			orient_type='GLOBAL',
			orient_matrix=(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-4.94379e-05, -0.0108994, 0.000300643),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.000399211, -0.0249535, 0.00217473),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00364322, 0.0140618, -1.59717e-05),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00498601, 0.0192433, -7.5071e-06),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00663937, 0.026988, -3.09502e-06),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00768523, 0.0376021, 1.43662e-06),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.000803819, 0.00954673, 1.44259e-05),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-1.61627e-16, -8.03529e-16, 0.000704463),
				"orient_type":'NORMAL',
				"orient_matrix":(
					(-0.979746, -0.200243, -3.54901e-10),
					(0.200243, -0.979746, 7.13482e-11),
					(-3.62e-10, -1.16347e-12, 1)),
...
class GA_PT_Tools_ExtrudedCurve(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.curve.primitive_nurbs_path_add(
			radius=0.5,
			enter_editmode=False,
			location=(0.00421777, -0.35954, 1.70905))
...
class GA_PT_Tools_Hair(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.transform.rotate(
			...
			orient_type='VIEW',
			orient_matrix=(
				(-4.93038e-32, -1, -2.22045e-16),
				(-2.22045e-16, -4.93038e-32, -1),
				(-1, -2.22045e-16, -4.93038e-32)),
			orient_matrix_type='VIEW',
			mirror=True,
			use_proportional_edit=False,
			proportional_edit_falloff='SMOOTH',
		...
		bpy.ops.transform.resize(
			...
			orient_type='VIEW',
			orient_matrix=(
				(-0.410029, -0.911976, 0.0132648),
				(0.401743, -0.193644, -0.895045),
				(-0.818828, 0.361665, -0.445779)),
			orient_matrix_type='VIEW',
			mirror=True,
			use_proportional_edit=False,
			proportional_edit_falloff='SMOOTH',
...
class GA_PT_Tools_RingCircle(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.mesh.primitive_torus_add(
			location=(-0.00227314, -0.0087918, -0.013097),
			rotation=(0, 0, 0),
			major_segments=12,
			minor_segments=4,
			major_radius=1,
...
class GA_PT_Tools_Axe(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.mesh.primitive_cylinder_add(
			enter_editmode=False,
			location=(0, 0, 0.818853))

		bpy.ops.transform.resize(
			value=(0.055, 0.055, 0.025),
			orient_type='GLOBAL',
			mirror=False,
			use_proportional_edit=False,
			proportional_edit_falloff='SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(2.47638e-10, 0.0780657, -0.0765976),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(2.40561e-10, 0.212529, -0.0413638),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-9.62075e-11, -0.00180802, -0.0891602),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-1.2189e-10, -0.110631, -0.00950289),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(2.16133e-10, -0.101079, -0.0457134),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(3.21695e-10, 0.0279483, -0.0739753),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-3.06656e-10, 0.0292209, -0.0647398),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-1.98725e-10, -0.0769222, 0.0127718),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-1.38058e-10, -0.0681638, 0.0318949),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(2.18559e-10, -0.0734853, 0.0693971),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(2.13181e-10, -0.0133702, 0.101631),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-2.24659e-10, 0.0121764, 0.115206),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
...
class GA_PT_Tools_Shoulder(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.transform.translate(
			value=(-0.0826497, -1.94363e-09, 0.0772539),
			orient_type='GLOBAL',
			orient_matrix=(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0623267, 2.22045e-16, -0.0235535),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0493649, -0.0814961, 0.0125206),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0156111, 0.0162923, 0.0268505),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.030259, 0.0219638, 0.0338485),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0694205, -0.0227891, 0.0259963),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0826899, 0.000881597, 0.0211338),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.transform.translate(
			value=(-0.0929743, -0.0651475, 0.0622001),
			orient_type='GLOBAL',
			orient_matrix=(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0826899, -0.000881605, -0.0211338),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0958697, -0.0579801, 0.00283617),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.118561, -0.0123266, 0.0176725),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.transform.translate(
			value=(-0.125035, -0.135511, 0.0017302),
			orient_type='GLOBAL',
			orient_matrix=(
				(1, 0, 0),
				(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.11856, 0.0123271, -0.0176725),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.108337, -0.0533254, -0.000413325),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.138605, -0.0143577, 0.0246369),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
...
class GA_PT_Tools_Sword(bpy.types.Operator):
	...
	def execute(self, context):
		...
		bpy.ops.mesh.primitive_plane_add(
			size=2,
			enter_editmode=False,
			location=(3.37511e-06, -1.11759e-08, 0.109301))
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0300433, 5.71785e-008, 0.0220003),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0132741, -4.07694e-009, 0.0540008),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0176937, -9.42212e-009, 0.1248),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0957351, -1.40763e-008, 0.186446),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.primitive_plane_add(
			size=2,
			enter_editmode=False,
			location=(3.37511e-06, 2.77613e-08, 0.2723))
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0585713, 8.68674e-009, -0.115059),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0361917, 1.67184e-010, -0.00221449),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0427634, -2.03823e-009, 0.0269972),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0208174, -2.1996e-009, 0.0291346),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0300255, 4.06311e-009, -0.0538175),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.156343, 5.46802e-009, -0.0724261),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00240966, 6.47707e-009, -0.0857914),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.00847854, 8.12588e-009, -0.107631),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.00841911, 1.71005e-009, -0.0226504),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.0215938, 1.0422e-009, -0.0138043),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.00817733, 2.36718e-009, -0.0313544),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0235766, 1.98995e-009, -0.0263575),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.0242162, 5.09147e-010, -0.00674379),
				"constraint_axis":(False, False, False),
				"orient_type":'GLOBAL',
				"mirror":False,
				"proportional_edit_falloff":'SMOOTH',
	...
	def execute(self, context):
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.037855, -1.6354e-09, 0.010038),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.027786, -4.47497e-09, 0.027467),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.010391, -6.13934e-09, 0.037683),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.009974, -6.11474e-09, 0.037532),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.042801, -6.84462e-09, 0.042012),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.001182, -6.86727e-09, 0.042151),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(0.018228, -1.21506e-09, 0.007458),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
		...
		bpy.ops.mesh.extrude_region_move(
			MESH_OT_extrude_region={
				...
				"mirror":False},
			TRANSFORM_OT_translate={
				"value":(-0.003453, -2.62042e-09, 0.016084),
				"orient_type":'GLOBAL',
				"orient_matrix":(
					(1, 0, 0),
					(0, 1, 0),
